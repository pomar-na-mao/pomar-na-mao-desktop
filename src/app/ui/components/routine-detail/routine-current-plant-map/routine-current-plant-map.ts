...
@Component({
  ...
  templateUrl: './routine-current-plant-map.html',
  host: {
    'style': 'display: contents'
  }
})
export class RoutineCurrentPlantMap implements OnInit, AfterViewInit, OnDestroy {
  @Input() id!: number;
  ...
  constructor() {
    effect(() => {
      ...
      const selectedPlant = this.repository.selectedRoutinePlant();
  ...
  public async ngOnInit(): Promise<void> {
    await Promise.all([
      this.routineRepository.fetchRoutines(),

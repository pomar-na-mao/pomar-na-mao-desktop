...
export class Sidebar {
  ...
  public menuItems: MenuItem[] = [
    ...
    { label: 'Fluxo de Pulverização', icon: 'M9 6.75V15m6-6v8.25m.503 3.446l-5.93-2.224a.75.75 0 00-.546 0l-5.93 2.224a.75.75 0 01-1.003-.694V5.708a.75.75 0 011.003-.694l5.93 2.224a.75.75 0 00.546 0l5.93-2.224a.75.75 0 011.003.694v12.708a.75.75 0 01-1.003.694z', path: '/fluxo-pulverizacao' },
    ...
    { label: 'Administração', icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z', path: '/administracao' },

...
export class Sidebar {
  ...
  public menuItems: MenuItem[] = [
    ...
    { label: 'Inclusoes em Massa', icon: 'M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5', path: '/inclusoes-em-massa' },
    ...
    { label: 'Usuarios', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', path: '/users' },
  ];
}

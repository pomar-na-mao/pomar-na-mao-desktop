alter table public.plant_attribute_change_history
  drop constraint if exists chk_plant_attribute_change_name;

alter table public.plant_attribute_change_history
  add constraint chk_plant_attribute_change_name

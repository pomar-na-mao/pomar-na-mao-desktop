drop function if exists public.get_annotation_operations(date, date, uuid);

create or replace function public.get_annotation_operations(
...
revoke all on function public.get_annotation_operations(date, date, uuid) from public, anon;
grant execute on function public.get_annotation_operations(date, date, uuid) to authenticated;
